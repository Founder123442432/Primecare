...
export default function Mobileapp() {
  ...
  return (
    <section className="bg-white h-[70dvh] mt-52 mb-52">
      <motion.div
        className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row"
      ...
      >
        ...
        >
          <img
            ...
            src="src/assets/medical-5459654_1280.png"
            alt="Medical App"
          />
        </motion.div>
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <h2 className="text-2xl font-semibold tracking-tight text-black xl:text-3xl">
            Download our free mobile app
          </h2>

          <p className="block max-w-2xl mt-4 text-black">
