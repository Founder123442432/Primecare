      ...
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form className="w-full max-w-md">
          ...
          <h2 className="text-slate-400 my-5">
            email and password log in coming soon
          </h2>
          <div className="mt-6">
            <button
              disabled
            ...
            <div
              onClick={GoogleLogin}
              className="flex items-center cursor-pointer justify-center px-6 py-3 mt-4 text-black transition-colors duration-300 transform border rounded-lg dark:border-gray-700  hover:bg-gray-50 dark:hover:bg-gray-600 hover:text-white"
            >
